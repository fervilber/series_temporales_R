...
### Estacionariedad 
Esta característica de las series incica si sus propiedades cámbian o no cambian con el tiempo, es decir si por ejemplo la media, la varianza o la covarianza son constantes en la serie o por el contrario cambian a lo largo de las observaciones de forma significativa.
...
El proposito de la transformación de series temporales es simplificar los patrones en los datos  y quitar las fuentes de variación evidentes. Se trata en definitiva de poder aplicar los métodos de pronóstico estadístico y por tanto de obtener una serie estacionaria sobre la que trabajar mejor.

Las transformaciónes de las series temporales extraen la esencia de los datos, y permiten analizar los componentes de tendencia, ciclo y variabilidad aparte, dando una mejor predicción.

Vamos a ver algunas transformaciones en los apartados siguientes.

## Transformaciones de Box-Cox para series de tiempo
La transformación de Box-Cox se usa para estabilizar la *varianza* de la serie.

a10 precargada, que contiene las ventas mensuales de medicamentos antidiabéticos en Australia desde 1991-2008.
